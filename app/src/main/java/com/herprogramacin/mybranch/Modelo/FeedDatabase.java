package com.herprogramacin.mybranch.Modelo;
...
import com.herprogramacin.mybranch.RssParse.Item;
    ...
    */
    ...
    public Cursor obtenerEntradas() {
        ...
        return getWritableDatabase().rawQuery(
                "select * from " + ScriptDatabase.ENTRADA_TABLE_NAME +" ORDER BY " + ScriptDatabase.ColumnEntradas.ID + " ASC", null);
    }
